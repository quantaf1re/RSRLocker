...
proposal_lock_time = 2592000  # 30 days in seconds
amount_rsr_to_lock = 10**22  # 10,000 nominal rsr
...
def main():
    ...
    locker_factory = LockerFactory.deploy(rsr.address, proposal_lock_time, amount_rsr_to_lock, owner_signer)
